...
export default function TimedEarlyAccessForm() {
      ...
      {!isSubmitted ? (
        ...
        >
          <h3 className="font-display text-xl font-bold">
            Be Among the First to Try Localli
          </h3>

          <p className="text-muted-foreground -mt-3 text-sm">
            Join a small group of early supporters shaping the future of how
            local businesses connect with their communities.
          </p>
        ...
        >
          ...
          <p className="text-muted-foreground mb-6">
            Thanks for joining our early access list. You’ll get updates, perks,
            and an invite before we open Localli to the public.
          </p>
